<?php
	...
	if($title && $message){
		 modules::addData(array('title', 'username', 'message', 'date'),array($title, $username, $message, date('Y-n-d')),'admin_messages');
	}
?>
                  ...
                  <form method="post">
                    <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                      ...
                      <tr>
                        ...
                        <td><textarea rows="" cols="" name="message"  class="form-textarea"></textarea></td>
                        <td></td>
                      </tr>
                      <tr>
                        <th>&nbsp;</th>
