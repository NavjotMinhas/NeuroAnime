		...
		<div id="content-table-inner">
            ...
            <?php 
				...
				foreach($array as $row){
					...
					echo'<h3>Click Url:'.$row['ClickUrl'].'</h3>';
					echo '<img src="../images/slider/'.$row['Image_File_Name'].'">';
					echo '<p>'.$row['Description'].'</p>';
					echo' <div class="messageFooter"><a href="removeslider.php?id='.$row['slider_id'].'&imagename='.$row['Image_File_Name'].'"><input type="button" value="Remove" /></a><br /></div>';
				}
